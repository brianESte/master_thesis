...
For segmenting a 3D mesh via Watershed Segmentation each vertex requires a measure of curvature.
Various forms and types of curvature were examined throughout this project.
