...
\begin{figure}[htb]
	...
	\begin{subfigure}{0.48\textwidth}
		\centering
			...
			\addplot[black]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_polygon.csv};
			\addplot[red]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_perim.csv};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{subfigure}{0.48\textwidth}
		...
		\begin{tikzpicture}[scale=1.0]
			...
			\addplot[black]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_polygon.csv};
			\addplot[red]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_sweep_1.csv};
			% Mark current corner
			\draw (axis cs:-0.614514, 3.89323) circle[radius=2pt]
				node[coordinate,label=right:{$c_{curr}$}] {}; % was pin
			% Mark post-shift waypoint
			\draw[red,fill=red] (axis cs:-0.284931, 2.71528) circle[radius=1.2pt];
	...
	\begin{subfigure}{0.48\textwidth}
		...
		\begin{tikzpicture}[scale=1.0]
			...
			\addplot[black]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_polygon.csv};
			\addplot[red]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_sweep_2.csv};
	...
	\begin{subfigure}{0.48\textwidth}
		...
		\begin{tikzpicture}[scale=1.0]
			...
			\addplot[black]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_polygon.csv};
			\addplot[red]
				table[mark=none,col sep=comma] {../resources/boustrophedon/ex_1_sweep_3.csv};
			% Circle at current corner
			\draw (axis cs:8.76958, 5.67303) circle[radius=2pt]
				node[coordinate,label={left:{$c_{curr}$}}] {};
			% Mark waypoints
			\draw[red,fill=red] (axis cs:10.6151, 2.71528) circle[radius=1.2pt];
			\draw[red,fill=red] (axis cs:10.6172, 2.88409) circle[radius=1.2pt];
			\draw[red,fill=red] (axis cs:10.187, 3.51528) circle[radius=1.2pt];
			% Mark current direction / edge
