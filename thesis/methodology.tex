...
This work's implementation of Watershed builds on both Mangan and Whitker's as well as Atkar et al.'s version.
...
(? perhaps talk about other (untested) ideas?)
...
\begin{figure}[htb]
	...
	\end{subfigure}
	\caption{Visual depiction of boustrophedon path planning steps. (? TODO: remove border "axes" on graphics, increase size a litle bit)}
