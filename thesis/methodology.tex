...
\begin{enumerate}
	...
	\item Descent to Minima: Descend from all remaining indepentent vertices to labeled regions
...
\caption{Complete polygon graph of the example polygon (! TODO: improve quality, most likely by replacing/recreating with TikZ)}
