...
Mature branches are active branches that have grown to a splitting node, but have not been fully utilized in the creation of polygon nodes.
% NOTE: ^hm
...
The solution proposed here amounts to the ``brute-force'' method of solving the set partitioning problem.
