...
\begin{tikzpicture}[]
	...
	\node[FC-Node, text width=28mm] (PrimCl) [right=\dx of WS] {Surface Classification};
	...
	\draw [FC-Arrow, rounded corners=5pt] (PrimCl.south) -- +(0,-0.4) -| (WS.south)
		node[pos=0.5,below right]{Composite surfaces};
...
\begin{figure}[htb]
	\centering
	% NOTE: There is probably a way to set all vertex labels with font size small...
\begin{tikzpicture}
	% Draw complete vertex graph
	\draw[very thick]
		(0,0) node (N0) [vertex,label=225:\small 0] {} --
		(1,0) node (N1) [vertex,label=287.5:\small 1] {} --
		(2,1) node (N2) [vertex,label=287.5:\small 2] {} --
		(4,1) node (N3) [vertex,label=247.5:\small 3] {} --
		(5,0) node (N4) [vertex,label=247.5:\small 4] {} --
		(6,0) node (N5) [vertex,label=315:\small 5] {} --
		(6,1) node (N10)[vertex,label= 0:\small 10] {} --
		(6,3) node (N6) [vertex,label= 45:\small 6] {} --
		(4,3) node (N8) [vertex,label= 90:\small 8] {} --
		(2,3) node (N12)[vertex,label=90:\small 12] {} --
		(0,3) node (N7) [vertex,label=135:\small 7] {} --
		(0,1) node (N9) [vertex,label=180:\small 9] {} -- cycle;
	\draw[very thick] (N2) --
		(3,2) node (N11)[vertex,label= 0:\small 11] {} -- (N8);
	\draw[very thick] (N2) -- (N9);
	\draw[very thick] (N3) -- (N10);
	\draw[very thick] (N3) -- (N11) -- (N12);
	\node at (0.7,0.5) {\Large 0};
	\node at (1.2,2.0) {\Large 3};
	\node at (3.0,1.4) {\Large 2};
	\node at (3.0,2.6) {\Large 4};
	\node at (4.8,2.0) {\Large 5};
	\node at (5.3,0.5) {\Large 1};
\end{tikzpicture}
	\caption{%
...
% TODO: figure out how to write the PGFplots styles more concisely
% Even after switching to PGFPlots, the styles repeat, so i could make this cleaner by
...
\begin{figure}[htb]
	\centering
	% TODO: update this graphic with the newest state of the GUI
\begin{tikzpicture}[scale=0.9,
	...
	\draw[-{Latex[round]}] (-7.55,3.7) node[nBalloon] {3} -- +(350:3.5mm); % Check mesh quality
	...
	\draw[-{Latex[round]}] (-2.4,2.37) node[nBalloon] {5} -- +(180:3.5mm); % Smoothing sigma
	\draw[-{Latex[round]}] (-2.4,1.87) node[nBalloon] {6} -- +(180:3.5mm); % Merge threshold
	% YieldPoint window
	...
	% Execute path
	\draw[-{Latex[round]}] (-2.4,-2.40) node[nBalloon] {8} -- +(180:3.5mm);
	...
	\draw[-{Latex[round]}] (-1,-3.9) node[nBalloon, in front of path] {11} -- +(270:4.4mm);
\end{tikzpicture}
...
% NOTE: Is there any merit in describing the unit tests created?
