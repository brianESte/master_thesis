...
\Metadata{
	title=Coverage Path Planning via Segmentation and Simplification,
	author=Brian Stephenson
}

\title{Coverage Path Planning via Segmentation and Simplification}
