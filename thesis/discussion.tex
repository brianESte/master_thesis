...
\begin{figure}[htb]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		...
		\begin{tikzpicture}[scale=0.85]
			\draw[thick] (0,3) arc[start angle=90, delta angle=-90, radius=3] -- (5,0)
				-- (5,5) -- (0,5) -- cycle;
		\end{tikzpicture}
...
% The dashed red lines show the result of extending the interior edges.
	...
	\end{subfigure}
	% TODO: Expand boustrophedon to handle the shape shown here, and add another subfigure showing the results
	\caption{%
...
% TODO:talk about fig (c), if there is one
}
\end{figure}
